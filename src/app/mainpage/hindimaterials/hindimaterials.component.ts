...
@Component({
  selector: 'app-hindimaterials',
  templateUrl: './hindimaterials.component.html',
  styleUrls: ['./hindimaterials.component.css']
})
export class HindimaterialsComponent {
  vocabdata=[ 
    { 
  ...
  GotoAssesments(){
    this.router.navigateByUrl('/mainpage/hindiassessments');
  }
